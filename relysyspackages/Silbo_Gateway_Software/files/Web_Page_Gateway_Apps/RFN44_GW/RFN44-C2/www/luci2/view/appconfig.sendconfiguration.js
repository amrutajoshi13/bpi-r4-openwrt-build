L.ui.view.extend({
	...
	SDCreateFormCallback: function()
	{
		...
		s.option(L.cbi.InputValue,'Parameterkey' ,{                            
	      ...
	      s.option(L.cbi.InputValue,'Parametervalue' ,{                            
			caption: L.tr('Field JSON Key Value')                                
	    }).depends({'DIOCustomfield1':'DIOCustomfield1'})
	     .depends({'DIOCustomfield2':'DIOCustomfield2'})
	     .depends({'DIOCustomfield3':'DIOCustomfield3'})
	     .depends({'DIOCustomfield4':'DIOCustomfield4'})
	     .depends({'DIOCustomfield5':'DIOCustomfield5'});
	...
	SACreateFormCallback: function()
	{
		...
		.value("AIValues3",L.tr("AIInput3"))                                
		.value("AIValues4",L.tr("AIInput4"))
