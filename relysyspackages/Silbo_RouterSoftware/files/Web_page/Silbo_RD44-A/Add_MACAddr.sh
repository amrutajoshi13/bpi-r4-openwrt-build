...
then
    sed -i 's|//wifi_enable_disable:true,|wifi_enable_disable:true,|g' /www/luci2/view/network.wireless.js
    sed -i 's|//wifi_enable_disable:true,|wifi_enable_disable:true,|g' /www/luci2/view/status.dashboard.js
    wifienabledisable=1
...
then 
   ...
   case $Value in 
      1)
        ...
        sed -i 's|<!--<img src="/luci2/icons/custom_logo.svg" class="logoimg" />-->|<img src="/luci2/icons/custom_logo.svg" class="logoimg" />|g' /www/luci2.html
