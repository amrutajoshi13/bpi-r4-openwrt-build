L.ui.view.extend({
	...
	execute: function () {
		...
		L.ui.createNote(
			null,
			`1.Manage user accounts and permissions for accessing the LuCI ui \n  2.After editing or deleting, please click the Save button to apply the saved configuration.`,
			{ type: 'info', variant: 'inline', appendTo: '#Update-Login-Note' }
		);
