	...
	GetUCISections: L.rpc.declare({
		...
		$('#btn_update_cellular').click(function () {
			...
			s5.option(L.cbi.CheckboxValue, 'enable_deviceid', {
                        ...
                        }).depends({'enablecellular':'1','smsenable1':'1'});	

			s5.option(L.cbi.DummyValue, 'smsdeviceid', {
    			        caption: L.tr('Serial Number'),
			}).depends({'enablecellular':'1','enable_deviceid': '1', 'smsenable1': '1' });

                        s5.option(L.cbi.CheckboxValue, 'enable_apikey', {
                                caption: L.tr('Enable API Key'),
                        }).depends({'enablecellular':'1','modemenable':'1','smsenable1':'1'})
                        ...
                        }).depends({ 'enablecellular':'1','enable_apikey': '1', 'smsenable1': '1' });
                        ...
                        }).depends({'validsmsreceivernumbers':'1','enablecellular':'1','modemenable':'1','smsenable1':'1'})
                          .depends({'validsmsreceivernumbers':'2','enablecellular':'1','modemenable':'1','smsenable1':'1'})
                          .depends({'validsmsreceivernumbers':'3','enablecellular':'1','modemenable':'1','smsenable1':'1'})
                          .depends({'validsmsreceivernumbers':'4','enablecellular':'1','modemenable':'1','smsenable1':'1'})
                          .depends({'validsmsreceivernumbers':'5','enablecellular':'1','modemenable':'1','smsenable1':'1'}); 
                        ...
                        }).depends({'enablecellular':'1','smsenable1':'1','enable_smscenternosim1':'1'});

                        
                        self.GetUCISections("sysconfig","sysconfig").then(function(rv){
                                var isDualSim = rv?.sysconfig?.CellularOperationMode;
                                console.log("CellularOperationMode:", isDualSim);

                                if (isDualSim === 'singlecellulardualsim') {
                                        /* SIM2 checkbox (define synchronously, not inside any .then()) */
                                        s5.option(L.cbi.CheckboxValue, 'enable_smscenternosim2', {
                                        caption: L.tr('Enable SMS Center Number for Sim2')
                                        }).depends(function(section_id){
                                        return this.map.data.get('sysconfig', 'CellularOperationMode') === 'singlecellulardualsim'
                                        && this.map.data.get('sysconfig', 'enablecellular') === '1'
                                        && this.map.data.get('smsconfig', 'smsenable1') === '1';
                                        });
                                        ...
                                        s5.option(L.cbi.InputValue, 'smscenternumber2', {
                                         ...
                                         .depends({'enable_smscenternosim2':'1'}); 
                                }
                        });
                        
                        m5.insertInto('#section_sms');
                        
                        self.GetUCISections("sysconfig","sysconfig").then(function () {
                                 m5.redraw();
                        });
