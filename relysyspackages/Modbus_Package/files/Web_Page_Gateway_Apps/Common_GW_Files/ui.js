			...
			var state = L.ui._login || (L.ui._login = {
				form: $('<form />')
					...
					.attr('method', 'post')
						...
						.text(L.tr('Hi, Welcome back!')))


                                                 .append($('<p />')
.addClass('loginbackmsg')

						.text(L.tr('Login back to use your account.')))
.append($('<p />')
						.addClass('alert alert-danger loginalert')
...
.addClass("inputlables")
			...
			L.ui.dialog('<img src="/luci2/icons/Silbo1.svg"/>', state.form, {
				style: 'confirm',
				confirm: state.confirm_cb
			});
					...
					//$('#changes')
						//.click(function(ev) {
							//L.ui.dialog(L.tr('Staged configuration changes'), html, {
								...
								//confirm: function() {
									L.uci.apply().then(
										function(code) { alert('Configuration applied Successfully'); location.reload(); },
...
if(_tag == ""){
_tag  = L.tr(nodes[i].title);
console.log(_tag)
      if(_tag == "Overview"){
      _tag ="<p><img src='/luci2/icons/category-2.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
 if(_tag == "General"){
      _tag ="<p><img src='/luci2/icons/category-2.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Router Software Upgrade"){
      _tag ="<p><img src='/luci2/icons/export.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Password"){
      _tag ="<p><img src='/luci2/icons/key.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Reboot"){
      _tag ="<p><img src='/luci2/icons/refresh.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Import Export Configurations"){
     _tag = 'Import / Export Config';
      _tag ="<p><img src='/luci2/icons/arrow-swap-horizontal.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Firmware Upgrade"){
      _tag ="<p><img src='/luci2/icons/Kernel.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Monitor Application"){
      _tag ="<p><img src='/luci2/icons/RouterAp.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
//if(_tag == "Logout"){
     // _tag ="<p><img src='/luci2/icons/export.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
//  }
...
if(_tag =="Application Start/Stop"){
      _tag ="<p><img src='/luci2/icons/Appstart-stop.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Interfaces"){
      _tag ="<p><img src='/luci2/icons/Interfaces.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Internet"){
      _tag ="<p><img src='/luci2/icons/Internet.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Loopback Rule"){
      _tag ="<p><img src='/luci2/icons/Loopback_rule.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Modem"){
      _tag ="<p><img src='/luci2/icons/Modem.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="MQTT Server Configuration"){
      _tag ="<p><img src='/luci2/icons/MQTT.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Others"){
      _tag ="<p><img src='/luci2/icons/Others.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Routes"){
      _tag ="<p><img src='/luci2/icons/Routes.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="RS485 Configuration"){
      _tag ="<p><img src='/luci2/icons/RS485.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Modbus TCP Configuration"){
      _tag ="<p><img src='/luci2/icons/TCP.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Remote Monitoring"){
      _tag ="<p><img src='/luci2/icons/RouterAp.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="Mac Address Binding"){
      _tag ="<p><img src='/luci2/icons/MACAddress_filtering.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
 
if(_tag == "URL Filtering"){
      _tag ="<p><img src='/luci2/icons/URL_Filtering.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }

if(_tag == "Tunnel"){
      _tag ="<p><img src='/luci2/icons/vpn.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
  
if(_tag =="Modbus Configuration"){
      _tag ="<p><img src='/luci2/icons/RS485.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }  
  
if(_tag == "Wifi MacID Filtering"){
      _tag ="<p><img src='/luci2/icons/wifi-off.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }

if(_tag == "Additional Commands"){
      _tag ="<p><img src='/luci2/icons/services.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }

if(_tag == "Source Configuration"){
      _tag ="<p><img src='/luci2/icons/iosource.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }  
  
if(_tag == "Fixed packet Configuration"){
      _tag ="<p><img src='/luci2/icons/database.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
  
if(_tag == "Send Configuration"){
      _tag ="<p><img src='/luci2/icons/database.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
  
if(_tag == "Storage Configuration"){
      _tag ="<p><img src='/luci2/icons/storage.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }     
  
//if(_tag == "HTTP Server Configuration"){
      //_tag ="<p><img src='/luci2/icons/cloud.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  //}
  
if(_tag == "Cloud Configuration"){
      _tag ="<p><img src='/luci2/icons/cloud.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
  
if(_tag == "RS232 Configuration"){
      _tag ="<p><img src='/luci2/icons/serial-port.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
  
if(_tag == "Digital Input Output Configuration"){
      _tag ="<p><img src='/luci2/icons/sensor.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
  
if(_tag == "Temperature Sensors Configuration"){
      _tag ="<p><img src='/luci2/icons/temperature.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }  

if(_tag == "Modbus Utility Configuration"){
      _tag ="<p><img src='/luci2/icons/RS485.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
 
if(_tag == "RS232 Utility Configuration"){
      _tag ="<p><img src='/luci2/icons/serial-port.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }            

if(_tag == "IO Utilities"){
      _tag ="<p><img src='/luci2/icons/Others.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Routing"){
      _tag ="<p><img src='/luci2/icons/routingicon.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Software Upgrade"){
       _tag ="<p><img src='/luci2/icons/Kernel.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>"; 
 } 
if(_tag == "Analog Input Configuration"){
    _tag ="<p><img src='/luci2/icons/analog.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>"; 
 } 
 
if(_tag == "Port Configuration"){
	_tag ="<p><img src='/luci2/icons/port.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  } 

if(_tag == "Custom Config"){
    _tag ="<p><img src='/luci2/icons/upload.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>"; 
 } 
if(_tag == "ADC Utility Configuration"){
 _tag ="<p><img src='/luci2/icons/analog.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>"; 
 }
 if(_tag == "Import / Export Application Configurations"){                                      
      _tag ="<p><img src='/luci2/icons/arrow-swap-horizontal.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";
  } 
if(_tag == "Application Software Upgrade"){
       _tag ="<p><img src='/luci2/icons/Kernel.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>"; 
 }  
if(_tag == "Connection Diagnostics"){
       _tag ="<p><img src='/luci2/icons/icons8-connection-24.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>"; 
 } 
 
if(_tag == "Sensor Events"){                                      
      _tag ="<p><img src='/luci2/icons/sensorevent.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";
  }   
}
